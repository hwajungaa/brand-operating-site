(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const n of document.querySelectorAll('link[rel="modulepreload"]'))s(n);new MutationObserver(n=>{for(const i of n)if(i.type==="childList")for(const o of i.addedNodes)o.tagName==="LINK"&&o.rel==="modulepreload"&&s(o)}).observe(document,{childList:!0,subtree:!0});function e(n){const i={};return n.integrity&&(i.integrity=n.integrity),n.referrerPolicy&&(i.referrerPolicy=n.referrerPolicy),n.crossOrigin==="use-credentials"?i.credentials="include":n.crossOrigin==="anonymous"?i.credentials="omit":i.credentials="same-origin",i}function s(n){if(n.ep)return;n.ep=!0;const i=e(n);fetch(n.href,i)}})();const x={brandId:"sample-brand",brandName:"Amore Creatives",brandNameKo:"아모레 크리에이티브",tagline:"Creating Beauty Beyond Boundaries",theme:{primaryColor:"#000000",secondaryColor:"#000000",accentColor:"#000000",backgroundColor:"#FFFFFF",surfaceColor:"#FFFFFF",textColor:"#000000",textSecondary:"#666666",borderColor:"#E8E8E8",fontHeading:"'Inter', sans-serif",fontBody:"'Noto Sans KR', sans-serif"},strategy:{purpose:{title:"Brand Purpose",content:"시간이 지나도 변하지 않는 본질적인 아름다움을 추구합니다.",mission:"모든 사람이 자신만의 아름다움을 발견하고 표현할 수 있도록 돕는다.",vision:"글로벌 프리미엄 뷰티 브랜드 Top 10",values:["Authenticity","Innovation","Sustainability","Elegance"]},personality:{title:"Brand Personality",keywords:["Confident","Sophisticated","Warm","Progressive"],spectrum:[{axis:"Formal ↔ Casual",position:25},{axis:"Classic ↔ Modern",position:60},{axis:"Bold ↔ Subtle",position:40},{axis:"Luxurious ↔ Accessible",position:30}]},principles:{title:"Brand Principles",main:"Clear Confidence",description:"명확한 자신감. 과잉 장식 없이 본질로 말한다.",subPrinciples:["진정성을 기반으로 소통한다","품질로 신뢰를 쌓는다","겸손하지만 흔들리지 않는다"]},designPrinciples:{title:"Design Principles",items:[{name:"Clear Hierarchy",description:"정보의 위계를 명확하게. 한눈에 핵심을 파악할 수 있는 구조.",doExample:"제목 → 서브카피 → 본문의 명확한 크기 차이",dontExample:"모든 텍스트가 비슷한 크기와 굵기"},{name:"Strong Focus",description:"하나의 핵심 메시지에 시선을 집중시킨다.",doExample:"메인 비주얼 1개 + 최소한의 텍스트",dontExample:"여러 이미지와 메시지가 경쟁하는 레이아웃"},{name:"Reduced Decoration",description:"불필요한 장식을 줄이고, 콘텐츠가 돋보이게 한다.",doExample:"충분한 여백과 깔끔한 레이아웃",dontExample:"과도한 그림자, 테두리, 패턴 남용"}]}},colors:{primary:[{name:"Navy",hex:"#1B2838",rgb:"27, 40, 56",cmyk:"85, 60, 35, 60",usage:"주요 텍스트, 로고, 핵심 요소"},{name:"Gold",hex:"#B8924A",rgb:"184, 146, 74",cmyk:"15, 30, 70, 10",usage:"강조, 포인트, CTA"},{name:"Cream",hex:"#F9F6F2",rgb:"249, 246, 242",cmyk:"2, 2, 4, 0",usage:"배경, 여백"}],secondary:[{name:"Deep Brown",hex:"#8B7355",rgb:"139, 115, 85",cmyk:"30, 35, 50, 20",usage:"보조 텍스트, 서브 요소"},{name:"Warm Gray",hex:"#A09890",rgb:"160, 152, 144",cmyk:"20, 20, 22, 15",usage:"비활성 상태, 보조 정보"},{name:"Light Sand",hex:"#EDE7DF",rgb:"237, 231, 223",cmyk:"5, 5, 8, 2",usage:"카드 배경, 구분선"}],functional:[{name:"Success",hex:"#5B8C6F",rgb:"91, 140, 111",usage:"성공, 확인"},{name:"Warning",hex:"#D4A853",rgb:"212, 168, 83",usage:"주의, 경고"},{name:"Error",hex:"#C75050",rgb:"199, 80, 80",usage:"오류, 삭제"}],ratio:{primary:60,secondary:30,accent:10}},typography:{heading:{fontFamily:"Pretendard",purchaseUrl:"https://cactus.tistory.com/306",license:"SIL Open Font License",weights:["Bold (700)","ExtraBold (800)"],usage:"제목, 타이틀, 강조 텍스트"},body:{fontFamily:"Pretendard",purchaseUrl:"https://cactus.tistory.com/306",license:"SIL Open Font License",weights:["Regular (400)","Medium (500)","SemiBold (600)"],usage:"본문, 캡션, UI 텍스트"},english:{fontFamily:"Inter",purchaseUrl:"https://rsms.me/inter/",license:"SIL Open Font License",weights:["Regular (400)","SemiBold (600)","Bold (700)","ExtraBold (800)"],usage:"영문 제목, 숫자, 코드"},scale:[{name:"Display",size:"48px",weight:"800",lineHeight:"1.15",letterSpacing:"-1.5px"},{name:"Heading 1",size:"36px",weight:"800",lineHeight:"1.25",letterSpacing:"-0.5px"},{name:"Heading 2",size:"28px",weight:"700",lineHeight:"1.3",letterSpacing:"-0.3px"},{name:"Heading 3",size:"22px",weight:"700",lineHeight:"1.35",letterSpacing:"0"},{name:"Heading 4",size:"18px",weight:"600",lineHeight:"1.4",letterSpacing:"0"},{name:"Body Large",size:"16px",weight:"400",lineHeight:"1.7",letterSpacing:"0"},{name:"Body",size:"14px",weight:"400",lineHeight:"1.7",letterSpacing:"0"},{name:"Caption",size:"12px",weight:"400",lineHeight:"1.5",letterSpacing:"0.2px"},{name:"Overline",size:"10px",weight:"600",lineHeight:"1.5",letterSpacing:"2px"}]},assets:{categories:[{id:"logo",name:"Logo",icon:"🏷️",formats:["SVG","PNG","AI","EPS"],count:6},{id:"symbol",name:"Symbol",icon:"◆",formats:["SVG","PNG","AI"],count:3},{id:"wordmark",name:"Wordmark",icon:"🔤",formats:["SVG","PNG","AI"],count:3},{id:"color-palette",name:"Color Palette",icon:"🎨",formats:["ASE","CLR","JSON"],count:1},{id:"typeface",name:"Typeface",icon:"✏️",formats:[],count:0,externalLink:!0},{id:"icon",name:"Icon",icon:"⬡",formats:["SVG","PNG"],count:24},{id:"pattern",name:"Pattern",icon:"▦",formats:["SVG","PNG","AI"],count:8},{id:"illustration",name:"Illustration",icon:"🖼️",formats:["SVG","PNG","AI"],count:12},{id:"graphic-motif",name:"Graphic Motif",icon:"✦",formats:["SVG","PNG","AI"],count:6},{id:"key-visual",name:"Key Visual",icon:"📸",formats:["PNG","PSD","AI"],count:4},{id:"product-rendering",name:"Product Rendering",icon:"📦",formats:["PNG","PSD"],count:10},{id:"photography",name:"Photography",icon:"📷",formats:["JPG","PNG"],count:20},{id:"motion-asset",name:"Motion Asset",icon:"🎬",formats:["MP4","MOV","GIF","Lottie"],count:5},{id:"presentation",name:"Presentation Template",icon:"📊",formats:["PPTX","KEY"],count:3},{id:"sns-template",name:"SNS Template",icon:"📱",formats:["PSD","Figma"],count:6}]},voiceTone:{tone:{description:"자신감 있되 겸손하게, 전문적이되 따뜻하게",keywords:["신뢰감 있는","세련된","따뜻한","명확한"],examples:{do:["당신의 피부가 가진 본래의 힘을 깨웁니다.","오랜 연구가 만든 확실한 결과.","자연에서 찾은 답, 과학으로 완성한 솔루션."],dont:["미친 할인! 지금 바로 구매하세요!!!","이거 안 사면 후회할 걸요~","경쟁사 제품과 비교 불가한 퀄리티!"]}},glossary:[{term:"LUXE",correct:"LUXE (대문자)",incorrect:"Luxe, luxe, 럭스"},{term:"스킨케어",correct:"스킨케어",incorrect:"스킨 케어, 스킨-케어"},{term:"에센스",correct:"에센스",incorrect:"에쎈스, 에센스류"}]},versions:[{version:"v3.0",date:"2025.06",summary:"브랜드 리뉴얼 — 로고, 컬러 시스템 전면 변경",type:"major"},{version:"v2.2",date:"2025.01",summary:"보조 컬러 2종 추가, SNS 가이드 업데이트",type:"minor"},{version:"v2.1",date:"2024.09",summary:"타이포그래피 가이드 보완, 모션 가이드 추가",type:"minor"},{version:"v2.0",date:"2024.03",summary:"디지털 전용 컬러 팔레트 신설",type:"major"},{version:"v1.0",date:"2023.06",summary:"초판 발행",type:"major"}],checkerRules:{logoMinMarginPx:20,logoMinSizePx:80,allowedColors:["#1B2838","#B8924A","#F9F6F2","#8B7355","#A09890","#EDE7DF","#FFFFFF","#000000"],officialFonts:["Pretendard","Inter"],colorTolerance:15}};let u=x,I=[{id:"sample-brand",name:"Amore Creatives",nameKo:"아모레 크리에이티브"}];function c(){return u||x}function z(a="sample-brand"){return u=x,B(u.theme),u}function k(){return I}function B(a){if(!a)return;const t=document.documentElement;t.style.setProperty("--primary",a.primaryColor||"#000000"),t.style.setProperty("--secondary",a.secondaryColor||"#000000"),t.style.setProperty("--accent",a.accentColor||"#000000"),t.style.setProperty("--bg",a.backgroundColor||"#FFFFFF"),t.style.setProperty("--surface",a.surfaceColor||"#FFFFFF"),t.style.setProperty("--text",a.textColor||"#000000"),t.style.setProperty("--text-secondary",a.textSecondary||"#666666"),t.style.setProperty("--border",a.borderColor||"#E8E8E8"),a.fontHeading&&t.style.setProperty("--font-heading",a.fontHeading),a.fontBody&&t.style.setProperty("--font-body",a.fontBody)}B(x.theme);const h={};function p(a,t){h[a]=t}function b(){const a=window.location.hash.slice(1);return(a.startsWith("/")?a:"/"+a)||"/"}function A(a){function t(){const e=b(),s=h[e]||h["/"],n=document.getElementById("content");if(n&&s)try{n.style.opacity="1",s(n)}catch(i){console.error("Error rendering route:",i)}finally{n.style.opacity="1"}a&&a(e)}window.addEventListener("hashchange",t),t()}const T=[{section:"Foundation",items:[{path:"/",icon:"◎",label:"Brand Strategy"},{path:"/assets",icon:"◆",label:"Asset Library"}]},{section:"Interactive Guide",items:[{path:"/colors",icon:"●",label:"Color System"},{path:"/typography",icon:"Aa",label:"Typography"},{path:"/voice-tone",icon:"✦",label:"Voice & Tone"}]},{section:"Governance",items:[{path:"/versions",icon:"⟳",label:"Version History"}]}];function L(a){const t=c(),e=b();let s="";T.forEach(i=>{s+=`<div class="sidebar-section-label">${i.section}</div>`,i.items.forEach(o=>{const r=o.path===e?" active":"";s+=`
    ...
    <div class="sidebar-version">
      ${n?`<span class="version-tag">${n.version}</span> ${n.date}`:""}
    </div>
  `,H(a)}function H(a){const t=a.querySelector("#sidebar-close-btn"),e=document.getElementById("sidebar-overlay");function s(){a.classList.remove("sidebar-open"),e&&e.classList.remove("active")}t&&t.addEventListener("click",s),a.querySelectorAll(".sidebar-link").forEach(n=>{n.addEventListener("click",s)})}function G(){const a=b();document.querySelectorAll(".sidebar-link").forEach(t=>{t.classList.toggle("active",t.dataset.path===a)})}const j={"/":"Brand Strategy","/assets":"Asset Library","/colors":"Color System","/typography":"Typography","/voice-tone":"Voice & Tone","/versions":"Version History"};function w(a){const t=c(),e=b(),s=j[e]||"Brand Operating Site";a.innerHTML=`
    <div class="header-left">
      <button class="mobile-menu-toggle" id="mobile-menu-toggle" aria-label="메뉴 열기">
        <span>☰</span>
      </button>
      <span class="header-title">${s}</span>
      <span class="header-breadcrumb">${t?.brandName||""} › ${s}</span>
    </div>
  ...
  `,N(),M(),R()}function N(){const a=document.getElementById("mobile-menu-toggle"),t=document.getElementById("sidebar"),e=document.getElementById("sidebar-overlay");!a||!t||(a.addEventListener("click",s=>{s.stopPropagation(),t.classList.toggle("sidebar-open"),e&&e.classList.toggle("active")}),e&&e.addEventListener("click",()=>{t.classList.remove("sidebar-open"),e.classList.remove("active")}))}function M(){const a=document.getElementById("search-input");a&&a.addEventListener("keydown",t=>{if(t.key==="Enter"){const e=a.value.trim().toLowerCase();if(!e)return;const s=c(),n=D(s,e);O(n,e)}})}function D(a,t){if(!a)return[];const e=[];["primary","secondary","functional"].forEach(n=>{a.colors?.[n]?.forEach(i=>{(i.name.toLowerCase().includes(t)||i.hex.toLowerCase().includes(t)||i.usage?.toLowerCase().includes(t))&&e.push({type:"color",label:`${i.name} (${i.hex})`,link:"#/colors",detail:i.usage})})}),a.assets?.categories?.forEach(n=>{(n.name.toLowerCase().includes(t)||n.id.toLowerCase().includes(t))&&e.push({type:"asset",label:n.name,link:"#/assets",detail:n.formats.join(", ")})}),["heading","body","english"].forEach(n=>{const i=a.typography?.[n];i&&i.fontFamily.toLowerCase().includes(t)&&e.push({type:"typography",label:i.fontFamily,link:"#/typography",detail:i.usage})});const s=a.strategy;return s&&(s.principles?.main?.toLowerCase().includes(t)&&e.push({type:"strategy",label:s.principles.main,link:"#/",detail:"Brand Principle"}),s.designPrinciples?.items?.forEach(n=>{(n.name.toLowerCase().includes(t)||n.description.toLowerCase().includes(t))&&e.push({type:"strategy",label:n.name,link:"#/",detail:n.description})})),e}function O(a,t){const e=document.getElementById("search-dropdown");e&&e.remove();const s=document.getElementById("global-search");if(!s)return;const n=document.createElement("div");n.id="search-dropdown",n.style.cssText=`
    position: absolute; top: 100%; left: 0; right: 0; margin-top: 4px;
    background: var(--surface); border: 1px solid var(--border); border-radius: var(--radius-md);
    box-shadow: var(--shadow-lg); z-index: 100; max-height: 300px; overflow-y: auto;
  `,a.length===0?n.innerHTML=`<div style="padding: 16px; text-align: center; color: var(--text-muted); font-size: 13px;">
      "${t}"에 대한 검색 결과가 없습니다.</div>`:n.innerHTML=a.map(i=>`
    ...
    `).join(""),s.style.position="relative",s.appendChild(n),setTimeout(()=>{document.addEventListener("click",function i(o){s.contains(o.target)||(n.remove(),document.removeEventListener("click",i))})},10)}function R(){const a=document.getElementById("brand-switcher-btn");a&&a.addEventListener("click",async()=>{const t=k(),e=document.getElementById("brand-dropdown");if(e){e.remove();return}const s=document.createElement("div");s.id="brand-dropdown",s.style.cssText=`
      position: absolute; top: 100%; right: 0; margin-top: 4px;
      background: var(--surface); border: 1px solid var(--border); border-radius: var(--radius-md);
      box-shadow: var(--shadow-lg); z-index: 100; min-width: 180px;
    `,s.innerHTML=t.map(n=>`
      <div class="brand-option" data-brand-id="${n.id}" style="padding: 10px 16px; cursor: pointer; font-size: 13px; font-weight: 600; transition: background 0.15s;"
           onmouseover="this.style.background='var(--bg)'" onmouseout="this.style.background='transparent'">
        ${n.name} <span style="font-size:11px; color: var(--text-muted);">${n.nameKo||""}</span>
      </div>
    `).join(""),a.style.position="relative",a.appendChild(s),s.querySelectorAll(".brand-option").forEach(n=>{n.addEventListener("click",()=>{z(n.dataset.brandId),L(document.getElementById("sidebar")),w(document.getElementById("header")),window.dispatchEvent(new HashChangeEvent("hashchange")),s.remove()})}),setTimeout(()=>{document.addEventListener("click",function n(i){a.contains(i.target)||(s.remove(),document.removeEventListener("click",n))})},10)})}function V(a){const t=c();if(!t)return;const e=t.strategy;let s="";e.personality?.spectrum?.forEach(i=>{s+=`
      <div class="spectrum-row">
        <span class="spectrum-label">${i.axis}</span>
        <div class="spectrum-bar">
          <div class="spectrum-dot" style="left: ${i.position}%"></div>
        </div>
      </div>`});let n="";e.designPrinciples?.items?.forEach(i=>{n+=`
    ...
    <div class="strategy-flow">
      <div class="strategy-level" style="background: #000; color: #fff;">
        ...
        <div class="level-title">${e.purpose?.content||""}</div>
        <div class="level-desc">${e.purpose?.mission||""}</div>
      </div>
      ...
      <div class="strategy-level" style="background: #222; color: #fff;">
        ...
        <div class="level-title">${e.personality?.keywords?.join(" · ")||""}</div>
      </div>
      <div class="strategy-arrow"></div>
      <div class="strategy-level" style="background: #444; color: #fff;">
        <div class="level-label">Brand Principles</div>
        <div class="level-title">${e.principles?.main||""}</div>
        <div class="level-desc">${e.principles?.description||""}</div>
      </div>
      <div class="strategy-arrow"></div>
      <div class="strategy-level" style="background: #F5F5F5; border: 1px solid #E8E8E8;">
        ...
        <div class="level-title" style="color: #000;">${e.designPrinciples?.items?.map(i=>i.name).join(" · ")||""}</div>
      </div>
      <div class="strategy-arrow"></div>
    ...
    <div class="card-grid cols-3" style="margin-bottom: 32px;">
      <div class="card">
        ...
        <div style="font-size:14px; font-weight:600; line-height:1.6;">${e.purpose?.mission||""}</div>
      </div>
      <div class="card">
        <div style="font-size:11px; font-weight:700; color:var(--secondary); margin-bottom:8px;">VISION</div>
        <div style="font-size:14px; font-weight:600; line-height:1.6;">${e.purpose?.vision||""}</div>
      </div>
      <div class="card">
        <div style="font-size:11px; font-weight:700; color:var(--secondary); margin-bottom:8px;">CORE VALUES</div>
        <div style="display:flex; flex-wrap:wrap; gap:6px; margin-top:4px;">
          ${(e.purpose?.values||[]).map(i=>`<span class="tag tag-gold">${i}</span>`).join("")}
        </div>
      </div>
    </div>
    ...
    <div class="card" style="margin-bottom: 32px;">
      <div style="display:flex; flex-wrap:wrap; gap:8px; margin-bottom:20px;">
        ${(e.personality?.keywords||[]).map(i=>`<span class="tag tag-primary" style="font-size:12px; padding:5px 14px;">${i}</span>`).join("")}
      </div>
      ${s}
    </div>
    ...
    <div class="card" style="margin-bottom: 32px; text-align: center; padding: 32px;">
      ...
      <div style="font-size:28px; font-weight:800; color:var(--text);">${e.principles?.main||""}</div>
      <div style="font-size:14px; color:var(--text-secondary); margin-top:8px;">${e.principles?.description||""}</div>
      <div style="display:flex; gap:12px; justify-content:center; margin-top:20px; flex-wrap:wrap;">
        ${(e.principles?.subPrinciples||[]).map(i=>`<span class="tag tag-gold" style="font-size:11px; padding:6px 14px;">${i}</span>`).join("")}
      </div>
    </div>
  ...
  `}function $(a,t=2500){const e=document.getElementById("toast-container");if(!e)return;const s=document.createElement("div");s.className="toast",s.textContent=a,e.appendChild(s),setTimeout(()=>{s.classList.add("fade-out"),setTimeout(()=>s.remove(),300)},t)}function f(a){navigator.clipboard.writeText(a).then(()=>{$(`복사됨: ${a}`)}).catch(()=>{$("복사 실패")})}function E(a){const t=parseInt(a.slice(1,3),16),e=parseInt(a.slice(3,5),16),s=parseInt(a.slice(5,7),16);return{r:t,g:e,b:s}}function F(a,t){function e(l,v,y){const[m,P,C]=[l,v,y].map(g=>(g=g/255,g<=.03928?g/12.92:Math.pow((g+.055)/1.055,2.4)));return .2126*m+.7152*P+.0722*C}const s=E(a),n=E(t),i=e(s.r,s.g,s.b),o=e(n.r,n.g,n.b),r=Math.max(i,o),d=Math.min(i,o);return((r+.05)/(d+.05)).toFixed(2)}function S(a){return a>=7?{level:"AAA",pass:!0}:a>=4.5?{level:"AA",pass:!0}:a>=3?{level:"AA Large",pass:!0}:{level:"Fail",pass:!1}}function U(a){const t=c();if(!t)return;const e=t.assets?.categories||[];let s=e.reduce((i,o)=>i+o.count,0),n=e.map(i=>`
  ...
  `).join("");a.innerHTML=`
    <div class="page-title">
      ...
      <h1>에셋 라이브러리</h1>
      <p class="page-desc">총 ${e.length}개 카테고리 · ${s}개 에셋을 포맷별로 탐색하고 다운로드합니다.</p>
    </div>

    <!-- Stats -->
    <div style="display:flex; gap:12px; margin-bottom:28px;">
      <div class="card" style="flex:1; text-align:center; padding:20px;">
        <div style="font-family:var(--font-heading); font-size:28px; font-weight:800; color:var(--secondary);">${e.length}</div>
      ...
      <div class="card" style="flex:1; text-align:center; padding:20px;">
        <div style="font-family:var(--font-heading); font-size:28px; font-weight:800; color:var(--secondary);">${new Set(e.flatMap(i=>i.formats)).size}</div>
    ...
    <div class="card" style="margin-bottom:24px;">
      <div style="display:flex; gap:24px; align-items:flex-start; flex-wrap:wrap;">
        ...
        <div id="logo-preview-area" style="flex:1; min-width:260px; display:flex; align-items:center; justify-content:center; min-height:160px; background:#fff; border:1px solid var(--border); border-radius:var(--radius-md); position:relative; overflow:hidden;">
          <div id="logo-preview" style="font-family:var(--font-heading); font-size:48px; font-weight:900; color:var(--primary); letter-spacing:-1px; transition: font-size 0.2s;">${t.brandName||"LOGO"}</div>
  ...
  `,W(t),K(t)}function W(a){const t=document.getElementById("logo-size-slider"),e=document.getElementById("logo-preview"),s=document.getElementById("logo-size-value"),n=document.getElementById("logo-margin-indicator"),i=document.getElementById("logo-preview-area");if(!t||!e)return;const o=a.checkerRules?.logoMinMarginPx||20;t.addEventListener("input",()=>{const r=t.value;e.style.fontSize=r*.4+"px",s.textContent=r+"px";const d=e.getBoundingClientRect(),l=i.getBoundingClientRect();n.style.width=d.width+o*2+"px",n.style.height=d.height+o*2+"px",n.style.left=d.left-l.left-o+"px",n.style.top=d.top-l.top-o+"px"}),document.querySelectorAll(".bg-preview-btn").forEach(r=>{r.addEventListener("click",()=>{i.style.background=r.dataset.bg;const d=r.dataset.bg==="#1B2838";e.style.color=d?"#FFFFFF":"var(--primary)"})})}function K(a){document.querySelectorAll(".asset-category-card").forEach(t=>{t.addEventListener("click",()=>{const e=t.dataset.catId,s=a.assets?.categories?.find(i=>i.id===e);if(!s)return;if(s.externalLink){$(`${s.name}: 유료 폰트 구매 페이지로 이동합니다.`);return}const n=document.getElementById("asset-detail");n.style.display="block",n.innerHTML=`
        <div class="card">
          ...
          <p style="font-size:13px; color:var(--text-secondary); margin-bottom:16px;">
            에셋 파일을 <code>brands/${a.brandId}/assets/${e}/</code> 폴더에 넣으면 이 카테고리에 자동으로 표시됩니다.
          </p>
          <div style="display:flex; gap:8px; flex-wrap:wrap;">
            ${s.formats.map(i=>`
      ...
      `,n.scrollIntoView({behavior:"smooth"})})})}function X(a){const t=c();if(!t)return;const{colors:e}=t;function s(r,d){return d.map(l=>`
    ...
    `).join("")}const n=[...e.primary||[],...e.secondary||[]];let i="";for(let r=0;r<n.length;r++)for(let d=r+1;d<n.length;d++){const l=n[r],v=n[d],y=F(l.hex,v.hex),m=S(y);i+=`
        ...
        </div>`}const o=e.ratio||{primary:60,secondary:30,accent:10};a.innerHTML=`
    <div class="page-title">
    ...
    <div class="card-grid cols-2">
      ...
      <div class="a11y-checker">
        ...
        <div class="a11y-selectors">
          <select id="a11y-fg">
            ${n.map((r,d)=>`<option value="${r.hex}" ${d===0?"selected":""}>${r.name} (${r.hex})</option>`).join("")}
          </select>
          <select id="a11y-bg">
            ${n.map((r,d)=>`<option value="${r.hex}" ${d===n.length-1?"selected":""}>${r.name} (${r.hex})</option>`).join("")}
          </select>
        </div>
    ...
    <div class="card" id="gradient-section">
      <div style="display:flex; gap:12px; margin-bottom:16px; align-items:center;">
        <select id="grad-color1" style="padding:6px 10px; border:1px solid var(--border); border-radius:var(--radius-sm); font-size:12px;">
          ${n.map((r,d)=>`<option value="${r.hex}" ${d===0?"selected":""}>${r.name}</option>`).join("")}
        </select>
        <span style="font-size:11px; color:var(--text-muted);">→</span>
        <select id="grad-color2" style="padding:6px 10px; border:1px solid var(--border); border-radius:var(--radius-sm); font-size:12px;">
          ${n.map((r,d)=>`<option value="${r.hex}" ${d===1?"selected":""}>${r.name}</option>`).join("")}
        </select>
  ...
  `,a.querySelectorAll(".copy-btn[data-copy]").forEach(r=>{r.addEventListener("click",d=>{d.stopPropagation(),f(r.dataset.copy)})}),a.querySelectorAll(".color-swatch").forEach(r=>{r.addEventListener("click",()=>{f(r.dataset.hex)})}),_(),q()}function _(){const a=document.getElementById("a11y-fg"),t=document.getElementById("a11y-bg"),e=document.getElementById("a11y-preview"),s=document.getElementById("a11y-result");if(!a||!t)return;function n(){e.style.color=a.value,e.style.background=t.value;const i=F(a.value,t.value),o=S(i);s.innerHTML=`
    ...
    `}a.addEventListener("change",n),t.addEventListener("change",n),n()}function q(){const a=document.getElementById("grad-color1"),t=document.getElementById("grad-color2"),e=document.getElementById("grad-angle"),s=document.getElementById("grad-preview"),n=document.getElementById("grad-css"),i=document.getElementById("grad-copy-btn");if(!a||!t)return;function o(){const r=`linear-gradient(${e.value}deg, ${a.value} 0%, ${t.value} 100%)`;s.style.background=r,n.textContent=r}a.addEventListener("change",o),t.addEventListener("change",o),e.addEventListener("change",o),o(),i?.addEventListener("click",()=>{f(n.textContent)})}function J(a){const t=c();if(!t)return;const{typography:e}=t;function s(i,o){return`
      <div class="card">
    ...
    <div class="type-preview-card" style="margin-bottom:12px;">
      ...
      <div class="type-preview-body">
        <div id="preview-${i.name.replace(/\s/g,"-")}" style="font-size:${i.size}; font-weight:${i.weight}; line-height:${i.lineHeight}; letter-spacing:${i.letterSpacing}; transition: font-size 0.2s;">
          ${t.brandName} 가나다라 ABCDEFG 0123456789
        </div>
      </div>
    </div>
  `).join("")||"";a.innerHTML=`
    ...
    <div class="card">
      <div style="display:flex; gap:16px; margin-bottom:16px; flex-wrap:wrap;">
        <select id="live-font" style="padding:6px 12px; border:1px solid var(--border); border-radius:var(--radius-sm); font-size:12px;">
          <option value="${e.heading?.fontFamily}">${e.heading?.fontFamily} (Heading)</option>
          <option value="${e.body?.fontFamily}">${e.body?.fontFamily} (Body)</option>
          <option value="${e.english?.fontFamily}">${e.english?.fontFamily} (English)</option>
        </select>
      ...
      <textarea id="live-textarea" style="width:100%; border:1px solid var(--border); border-radius:var(--radius-md); padding:20px; font-size:24px; font-weight:700; min-height:120px; resize:vertical; outline:none; transition: all 0.2s;" placeholder="여기에 텍스트를 입력하세요...">${t.brandName} — 시간이 지나도 변하지 않는 본질적인 아름다움</textarea>
    ...
    <div class="card-grid cols-2">
      <div class="card" style="text-align:center; padding:32px;">
        <div style="font-family:${e.heading?.fontFamily}; font-size:28px; font-weight:800; margin-bottom:8px;">Heading Style</div>
        <div style="font-family:${e.body?.fontFamily}; font-size:14px; color:var(--text-secondary); line-height:1.7;">
          본문 텍스트는 가독성을 최우선으로 합니다. 적절한 행간과 자간으로 읽기 편한 환경을 만듭니다.
        </div>
        <div style="margin-top:16px;">
          <span class="tag tag-gold">${e.heading?.fontFamily} + ${e.body?.fontFamily}</span>
        </div>
      </div>
      <div class="card" style="text-align:center; padding:32px;">
        <div style="font-family:${e.english?.fontFamily}; font-size:28px; font-weight:800; margin-bottom:8px;">English Heading</div>
        <div style="font-family:${e.body?.fontFamily}; font-size:14px; color:var(--text-secondary); line-height:1.7;">
          영문 제목에는 전용 서체를 사용하여 국제적인 톤을 유지합니다. 숫자와 데이터 표현에도 활용됩니다.
        </div>
        <div style="margin-top:16px;">
          <span class="tag tag-gold">${e.english?.fontFamily} + ${e.body?.fontFamily}</span>
        </div>
      </div>
    </div>
  `,Y(e),Q()}function Y(a){const t=document.getElementById("type-global-slider"),e=document.getElementById("type-global-value");t&&t.addEventListener("input",()=>{const s=t.value/100;e.textContent=t.value+"%",a.scale?.forEach(n=>{const i=document.getElementById(`preview-${n.name.replace(/\s/g,"-")}`);if(i){const o=parseFloat(n.size);i.style.fontSize=o*s+"px"}})})}function Q(a){const t=document.getElementById("live-textarea"),e=document.getElementById("live-font"),s=document.getElementById("live-weight"),n=document.getElementById("live-size"),i=document.getElementById("live-size-value"),o=document.getElementById("copy-font-css");if(!t)return;function r(){t.style.fontFamily=e.value,t.style.fontWeight=s.value,t.style.fontSize=n.value+"px",i.textContent=n.value+"px"}e?.addEventListener("change",r),s?.addEventListener("change",r),n?.addEventListener("input",r),o?.addEventListener("click",()=>{const d=`font-family: '${e.value}'; font-size: ${n.value}px; font-weight: ${s.value};`;f(d)})}function Z(a){const t=c();if(!t)return;const e=t.voiceTone,s=(e?.tone?.examples?.do||[]).map(o=>`<div class="dd-item">• ${o}</div>`).join(""),n=(e?.tone?.examples?.dont||[]).map(o=>`<div class="dd-item">• ${o}</div>`).join("");let i=(e?.glossary||[]).map(o=>`
    <tr>
  ...
  `).join("");a.innerHTML=`
    ...
    <div class="card" style="margin-bottom:24px; text-align:center; padding:32px;">
      ...
      <div style="font-size:22px; font-weight:800; color:var(--text); margin-bottom:12px;">"${e?.tone?.description||""}"</div>
      <div style="display:flex; gap:8px; justify-content:center; flex-wrap:wrap;">
        ${(e?.tone?.keywords||[]).map(o=>`<span class="tag tag-gold" style="font-size:12px; padding:5px 14px;">${o}</span>`).join("")}
      </div>
    </div>
  ...
  `}function ee(a){const t=c();if(!t)return;const e=t.versions||[],s=e[0];let n=e.map(i=>`
  ...
  `).join("");a.innerHTML=`
    ...
    <div style="display:flex; gap:12px; margin-bottom:28px;">
      ...
      <div class="card" style="flex:1; text-align:center; padding:20px;">
        <div style="font-family:var(--font-heading); font-size:28px; font-weight:800; color:var(--secondary);">${e.filter(i=>i.type==="major").length}</div>
        <div style="font-size:11px; color:var(--text-muted); margin-top:2px;">Major 릴리즈</div>
      </div>
      <div class="card" style="flex:1; text-align:center; padding:20px;">
        <div style="font-family:var(--font-heading); font-size:28px; font-weight:800; color:var(--secondary);">${e.filter(i=>i.type==="minor").length}</div>
  ...
  `}function te(){z("sample-brand"),L(document.getElementById("sidebar")),w(document.getElementById("header")),p("/",t=>V(t)),p("/assets",t=>U(t)),p("/colors",t=>X(t)),p("/typography",t=>J(t)),p("/voice-tone",t=>Z(t)),p("/versions",t=>ee(t)),A(t=>{G(),w(document.getElementById("header"))});const a=document.getElementById("content");a&&(a.style.opacity="1")}te();
